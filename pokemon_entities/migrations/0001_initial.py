# Generated by Django 3.1.14 on 2022-10-16 10:10
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('previous_evolution', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='parent', to='pokemon_entities.pokemon', verbose_name='Эволюция')),
            ],
        ),
        migrations.CreateModel(
            name='PokemonEntity',
            fields=[
                ...
                ('strength', models.IntegerField(blank=True, null=True, verbose_name='Прочность')),
